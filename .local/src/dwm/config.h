...
static const int user_bh            = 4;        /* extra height for bar, default:2 */
static const char *fonts[]          = {"Fira Code:size=10", "Font Awesome 5 Free:size=10", "Font Awesome 5 Brands:size=10", "Material Icons:size=10","monospace:size=10" };
...
static const char col_selborders[]  = "#458588";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, "-l", "20", "-i", NULL };
static const char *termcmd[]  = { "st", NULL };
static const char *htopcmd[]  = { "st", "-e", "htop", NULL };
static const char *rangercmd[]  = { "st", "-e", "ranger", NULL };
static const char *qutebrowsercmd[] = { "qutebrowser", "-R" };
/* to be added:
